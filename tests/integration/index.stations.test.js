...
describe('Stations', () => {
  ...
  describe('Points and scoring', () => {
    it('set points for any team and for any station', async () => {
      ...
      await adminPage.goto(`http://localhost:8080/wp-admin/admin.php?page=tuja&tuja_view=Group&tuja_competition=${competitionId}&tuja_group=${groupAliceProps.id}`)
      ...
      await adminPage.goto(`http://localhost:8080/wp-admin/admin.php?page=tuja&tuja_view=Group&tuja_competition=${competitionId}&tuja_group=${groupBobProps.id}`)
