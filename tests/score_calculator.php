...
$question->score_type = Question::GRADING_TYPE_ONE_OF;
...
$question = new Question(); // What is the capital of {possible_answer}?
$question->correct_answers = ['stockholm', 'copenhagen', 'oslo', 'helsinki'];
$question->possible_answers = ['Sweden', 'Denmark', 'Norway', 'Finland'];
$question->score_type = Question::GRADING_TYPE_ORDERED_PERCENT_OF;
$question->score_max = 10;
...
$question = new Question(); // Which are the capitals of the nordic countries?
$question->correct_answers = ['stockholm', 'copenhagen', 'oslo', 'helsinki', 'reykjavik'];
$question->score_type = Question::GRADING_TYPE_UNORDERED_PERCENT_OF;
$question->score_max = 10;
...
assert($question->score(['Stockholm', 'copenhaven', 'Oslo', 'helsinky', 'reikjavik']) == 10); // Slightly misspelled.
assert($question->score(['helsinki', 'reykjavik', 'stockholm', 'copenhagen', 'oslo']) == 10); // Different order.
assert($question->score(['Stockholm', 'copenhaven', 'Oslo', 'helsinky', 'berlin']) == 8); // Incorrect answers are ignored.

$question = new Question();
$question->correct_answers = ['alice', 'bob'];
$question->possible_answers = ['alice', 'bob', 'carol'];
$question->score_type = Question::GRADING_TYPE_ALL_OF;
$question->score_max = 10;
